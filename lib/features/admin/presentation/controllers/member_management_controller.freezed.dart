...
part of 'member_management_controller.dart';
...
mixin _$MemberManagementState {
  List<AdminUserEntity> get users => throw _privateConstructorUsedError;
...
abstract class $MemberManagementStateCopyWith<$Res> {
  factory $MemberManagementStateCopyWith(
    MemberManagementState value,
    $Res Function(MemberManagementState) then,
  ) = _$MemberManagementStateCopyWithImpl<$Res, MemberManagementState>;
  @useResult
  $Res call({List<AdminUserEntity> users, bool isLoading, String? error});
}

/// @nodoc
class _$MemberManagementStateCopyWithImpl<
  $Res,
...
class __$$MemberManagementStateImplCopyWithImpl<$Res>
    extends
        _$MemberManagementStateCopyWithImpl<$Res, _$MemberManagementStateImpl>
    implements _$$MemberManagementStateImplCopyWith<$Res> {
  __$$MemberManagementStateImplCopyWithImpl(
    _$MemberManagementStateImpl _value,
...
class _$MemberManagementStateImpl implements _MemberManagementState {
  const _$MemberManagementStateImpl({
    final List<AdminUserEntity> users = const [],
  ...
  @override
  @JsonKey()
  List<AdminUserEntity> get users {
  ...
  @override
  String toString() {
    return 'MemberManagementState(users: $users, isLoading: $isLoading, error: $error)';
  }
  ...
  get copyWith =>
      __$$MemberManagementStateImplCopyWithImpl<_$MemberManagementStateImpl>(
        this,
        _$identity,
      );
}
...
abstract class _MemberManagementState implements MemberManagementState {
  const factory _MemberManagementState({
