...
import '../providers/post_write_provider.dart';
...
class _PostWritePageState extends ConsumerState<PostWritePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const PrimaryAppBar(title: "게시글 추가"),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      PostHeaderImage(
                        ...
                        picsumUrl: postWriteState.picsumUrl,
                      ...
                      PostFormInputs(
                        ...
                        onCategoryChanged: (category) => postWriteNotifier.setCategory(category ?? '자유'),
